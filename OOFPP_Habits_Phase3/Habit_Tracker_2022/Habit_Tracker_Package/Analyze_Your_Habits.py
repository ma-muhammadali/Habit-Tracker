...
from Habit_Tracker_Package.Min_Max_Display_Conversion import Min_Max_Conversion
from Habit_Tracker_Package.Display_Habits_With_All_Columns import Display_All_Habits_Columns
from Habit_Tracker_Package.Clear_Screen_and_Progress_Bar import clear_screen
...
def analyze_your_habits(username):
    """The purpose of Analyze Your Habits is to display Analyze Your Habit Menu"""
    choice = ''

    while choice.lower() != 'x':

        print("\n*********************************************")
        print("\tAnalyze Your Habits Menu")
        print("*********************************************\n")
...
def display_all_tracked_habits(username):
    """The purpose of this function is to display All Tracked Habits"""
...
def display_all_deleted_habits(username):
    """The purpose of this function is to display All Deleted Habits"""
    sqliteconn = None
...
def display_all_completed_habits(username):
    """The purpose of this function is to display All Completed Habits"""
    sqliteconn = None
...
def display_all_daily_habits(username):
    """The purpose of this function is to display All Daily Habits"""
    sqliteconn = None
...
def display_all_weekly_habits(username):
    """The purpose of this function is to display All Weekly Habits"""
    sqliteconn = None
...
def display_smallest_streak_daily_habits(username):
    """The purpose of this function is to display smallest streak daily Habits"""
    sqliteconn = None
...
def display_smallest_streak_weekly_habits(username):
    """The purpose of this function is to display smallest streak weekly Habits"""
    sqliteconn = None
...
def display_smallest_streak_among_all_habits(username):
    """The purpose of this function is to display smallest streak among all habits (daily or weekly)"""
    sqliteconn = None
...
def display_longest_streak_daily_habits(username):
    """The purpose of this function is to display longest streak daily Habits"""
    sqliteconn = None
...
def display_longest_streak_weekly_habits(username):
    """The purpose of this function is to display longest streak weekly Habits"""
    sqliteconn = None
...
def display_longest_streak_among_all_habits(username):
    """The purpose of this function is to display longest streak among all habits (daily or weekly)"""
    sqliteconn = None
...
def display_longest_streak_given_habit(username):
    """The purpose of this function is to display longest streak given habit"""
    sqliteconn = None
...
def display_active_habits(username):
    """The purpose of this function is to display Active habits"""
    sqliteconn = None
...
def display_completed_habits(username):
    """The purpose of this function is to display Completed habits"""
    sqliteconn = None
...
def display_deleted_habits(username):
    """The purpose of this function is to display Deleted habits"""
    sqliteconn = None
...
def get_habit_status_color(habitstatus):
    """The purpose of this function is to display icon and its color based on Habit status.
    Active (Blue ➠ ), Completed (Green  ✅ ), Deleted (Red ❌) """
...
def print_habit_tracker_table(tablerecords, choice):
    """The purpose of this function is to display Habit Tracker list (without Habit Id) in form of table based on choice"""
    try:
...
def print_habit_tracker_table_min_max_values(tablerecords, choice):
    """The purpose of this function is to display Habit Tracker Smallest & Longest Streak habits"""
    try:
        # Display Data In Table Form
        if choice == '6':
...
def print_habit_tracker_table_all_columns(tablerecords, choice):
    """The purpose of this function is to display Habit Tracker list (with Habit Id) in form of table based on choice"""
    try:
        # Display Data In Table Form
        if choice == '12':
            table = Table(title="All Tracked Habits", highlight="True", show_header=True, header_style="bold green")
