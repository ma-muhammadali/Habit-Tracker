...
def display_complete_habit__alert():
    """The purpose of this function is to start habit complete alert thread."""
...
def display_over_due_habit_alert():
    """The purpose of this function is to start overdue habit alert thread."""
...
def alert_habit_completed():
    """The purpose of this function is to display message box when habit completes."""
    ctypes.windll.user32.MessageBoxW(0, "Your Habit Has Been Completed\n", "ALERT", 0)


def alert_overdue_habits_reset():
    """The purpose of this function is to display message box when overdue habit reset."""
...
def complete_max_days_and_reset_overdue_habits(username):
    """The purpose of this function is to calculate which habits has completed and which habits are overdue automatically."""
    try:
        time.sleep(10)
        sqliteconn = None
