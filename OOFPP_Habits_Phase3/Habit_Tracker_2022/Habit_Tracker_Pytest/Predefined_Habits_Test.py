...
def insertpredefinedhabits(usr_name):
    ...
    try:
        ...
        habits2 = [('Drink Water', 'Drink 2 Liters of Water', 'Daily', current_date, current_date, previous_date, 1, 1,
                   2, 0, 1, usr_name),
                  ('Offer Prayer', 'Offer Prayer 5 Time a Day', 'Daily', previous_date, previous_date, current_date, 2,
                   2, 2, 0, 1, usr_name),
                  ...
                  1, usr_name),
                  (
                  'Cleaning', 'Clean House on Weekend', 'Weekly', current_date, current_date, next_date_weekly, 0, 0, 0,
                  0, 1, usr_name),
                  (
        ...
        dbconn.executemany(
            ...
            habits2)
        sqliteconn.commit()
        print("\n8 Predefined Habits Has Been Added To ( ", usr_name, " ) Tracker....")
        time.sleep(3)
...
def loadpredefinedhabits(username):
    ...
    try:
        from Clear_Screen_and_Progress_Bar_Test import Progress
        Progress()
