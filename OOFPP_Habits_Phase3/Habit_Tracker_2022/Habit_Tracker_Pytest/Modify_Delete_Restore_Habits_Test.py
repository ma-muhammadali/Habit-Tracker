...
def change_habit_title(habitid, habittitle, username):
    sqliteconn = None
                    ...
                    if habit_id == -1:
                        ...
                        if habit_id in user_habits_id_list:
                            ...
                            while repeat_habit_name:
                                ...
                                new_habit_title = str(habittitle).strip()
                            ...
                            dbconn.execute(command, {'hbt_id': habit_id, 'hbt_title': new_habit_title})
                            sqliteconn.commit()
                            sqliteconn.close()
                            if dbconn.rowcount > 0:
                                print("Habit Title Updated Successfully\n")
...
def change_habit_description(habitid, habitdescription, username):
    sqliteconn = None
        ...
        while repeat:
            try:
                ...
                if lenrecords > 0:
                    ...
                    habit_id = int(habitid) #int(user_input)
                    ...
                    if habit_id == -1:
                        ...
                        if habit_id in user_habits_id_list:
                            ...
                            while repeat_habit_desc:
                                ...
                                new_habit_description = str(habitdescription).strip()
                            ...
                            dbconn.execute(command, {'hbt_id': habit_id, 'hbt_desc': new_habit_description})
...
def change_habit_period_to_daily(habitid, username):
    sqliteconn = None
...
def change_habit_period_to_weekly(habitid, username):
    sqliteconn = None
...
def change_habit_max_days(habitid, maxdays, username):
    sqliteconn = None
                    ...
                    if habit_id == -1:
                        ...
                        if habit_id in user_habits_id_list:
                            ...
                            while repeat_habit_max_days:
                                ...
                                new_habit_max_days = str(maxdays).strip()
...
def delete_habit(habitid, username):
    sqliteconn = None
...
def restore_deleted_habit(habitid, username):
    sqliteconn = None
...
def restore_completed_habit(habitid, username):
    sqliteconn = None
    ...
    try:
        ...
        while repeat:
            ...
            try:
                ...
                if lenrecords > 0:
                    from Analyze_Your_Habits_Test import display_completed_habits
                    display_completed_habits(username)
